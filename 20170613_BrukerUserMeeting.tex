		...
		\begin{column}[T]{0.4\linewidth}
			...
			\only<3>{%
				...
				\begin{tikzpicture}[remember picture,overlay]%
					\node[xshift=0.309\paperwidth,yshift=0.25\paperheight] at (current page.south west){%
						%\includegraphics[width=0.5\paperwidth]{./movies/b51_hull/b51_bb_d16t06_threshold_0001}%
						\animategraphics[autoplay,width=0.5\paperwidth,every=\everyframe]{24}{./movies/b51_hull/b51_bb_d16t06_threshold_0}{001}{361}%
						};%
				\end{tikzpicture}%
			}
			\only<4>{%
				...
				\begin{tikzpicture}[remember picture,overlay]%
					\node[xshift=0.309\paperwidth,yshift=0.25\paperheight] at (current page.south west){%
						%\includegraphics[width=0.5\paperwidth]{./movies/b51_hull/b51_bb_d16t06_threshold_0001}%
						\animategraphics[autoplay,width=0.5\paperwidth,every=\everyframe]{24}{./movies/b51_threshold/b51_bb_d16t06_threshold_0}{001}{361}%				
					};%
				\end{tikzpicture}%
			...
			\only<5>{%
				...
				\begin{tikzpicture}[remember picture,overlay]%
					\node[xshift=0.309\paperwidth,yshift=0.25\paperheight] at (current page.south west){%
						%\includegraphics[width=0.5\paperwidth]{./movies/b51_hull/b51_bb_d16t06_threshold_0001}%
						\animategraphics[autoplay,width=0.5\paperwidth,every=\everyframe]{24}{./movies/b51_overlay/b51_bb_d16t06_threshold_0}{001}{361}%				
						};%
				\end{tikzpicture}%
			}%
			\only<6>{%
				...
				\begin{tikzpicture}[remember picture,overlay]%
					\node[xshift=0.309\paperwidth,yshift=0.25\paperheight] at (current page.south west){%
						%\includegraphics[width=0.5\paperwidth]{./movies/b51_hull/b51_bb_d16t06_threshold_0001}%
						\animategraphics[autoplay,width=0.5\paperwidth,every=\everyframe]{24}{./movies/b51_cleaned/b51_bb_d16t06_threshold_0}{001}{361}%				
						};%
				\end{tikzpicture}%
			}%			
			\only<7>{%
				\begin{tikzpicture}[x=\imagescale,y=-\imagescale]
					\node[anchor=north west, inner sep=0pt, outer sep=0pt] at (0,0) {\includegraphics[width=\imagewidth]{./img/imageprocessing/{{B51_bb_D16T06_edtIJ_0666}}}};
					\draw[|-|,white,thick] (\x,\y) -- (\x+100,\y) node [right] {\SI{500}{\micro\meter}};
				\end{tikzpicture}%
			}%
			\only<8>{%
				\begin{tikzpicture}[x=\imagescale,y=-\imagescale]
					\node[anchor=north west, inner sep=0pt, outer sep=0pt] at (0,0) {\includegraphics[width=\imagewidth]{./img/imageprocessing/{{B51_bb_D16T06_surfaceIJ_0666}}}};
					\draw[|-|,white,thick] (\x,\y) -- (\x+100,\y) node [right] {\SI{500}{\micro\meter}};
				\end{tikzpicture}%
			}%
			\only<9>{%
