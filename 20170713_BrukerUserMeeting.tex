...
%		\pause
%		\begin{tikzpicture}[remember picture,overlay]
%    		\node[xshift=8cm, yshift=-4cm, rotate=-45, fill=gray, opacity=0.618, rounded corners=5, text opacity=1] at (current page.north west) {\huge Easy!};
%		\end{tikzpicture}
		\item[]	
		\pause	
...
%		\pause
%		\begin{tikzpicture}[remember picture,overlay]
%		    \node[xshift=8cm, yshift=-7cm, rotate=-45, fill=unibe, rounded corners=0.5, opacity=0.618, text opacity=1] at (current page.north west) {\huge A bit harder\ldots};
%		\end{tikzpicture}
	\end{itemize}
\end{frame}
	...
	\begin{columns}
		\begin{column}{0.6\linewidth}
			\begin{itemize}
				...
				\item Two treatments vs.\ control at three time points
				\begin{itemize}
					\item Classic radiation therapy \& Microbeam treatment
					\item \SIlist{16;20;24}{\day} post tumor implantation
				\end{itemize}
				\item Brain vessels instilled with \uaf~\cite{Schaad2017}
				\item Nondestructive extraction of
				\begin{itemize}
					\item Tumor vascularization\newline{}
						(Vessel volume per tumor volume)
					\item Vessel surface
		...
		\begin{column}{0.21\linewidth}
			...
			\begin{tikzpicture}[x=\imagescale,y=-\imagescale]
				...
				\pause
				\draw<2>[red, ultra thick] (187,182) circle (50);
			\end{tikzpicture}%
		\end{column}%
		\begin{column}{0.21\linewidth}%
			\pgfmathsetlength{\imagewidth}{\imsize}%
			...
			\begin{tikzpicture}[x=\imagescale,y=-\imagescale]
				...
				\draw<2>[red, ultra thick] (199,187) circle (50);
			\end{tikzpicture}%
		\end{column}
	\end{columns}
\end{frame}
	...
	\begin{overprint}% Solve the jumping text problem https://tex.stackexchange.com/a/17947/828
		...
		\begin{tikzpicture}[remember picture,overlay]%
			\node[xshift=0,yshift=-0.085\paperheight-0.016\paperheight/2] at (current page.center){%
				\animategraphics[autoplay,width=\imsize,every=\everyframe]{24}{movies/b01_mov_small/b01_ctrl_d20t10_ir_rec00000}{001}{361}%
			};%
		\end{tikzpicture}%
		}%
	\end{overprint}	
	...
	\begin{columns}
		\begin{column}[T]{0.48\linewidth}
			\begin{itemize}
				...
				\item<8-> Labelling/counting objects \textrightarrow{} IMD
			\end{itemize}
		\end{column}
		\begin{column}[T]{0.48\linewidth}
			\only<1>{%
