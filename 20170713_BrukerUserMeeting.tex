...
\begin{frame}
	\frametitle{What}
	\begin{itemize}
		\item 57099 incidences of brain and central nervous system cancer in Europe in 2012
	...
	\end{itemize}
	\source{Incidence \#: \href{http://eco.iarc.fr/eucan/Cancer.aspx?Cancer=34\#tabs-both}{EUCAN}}
\end{frame}
...
\begin{frame}
	...
	\pause
	\begin{tikzpicture}[remember picture,overlay]
		\node[xshift=6cm, yshift=-6cm, rotate=-45] at (current page.north west) {\huge That's the hard part!};
	\end{tikzpicture}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{tikzpicture}[remember picture,overlay]
		    \node[xshift=6cm, yshift=-4cm, rotate=-45] at (current page.north west) {\huge Easy!};
		\end{tikzpicture}
		\item[]	
		\pause	
		...
		\item Standardized measure to assess tumor angiogenesis.
			Done on LM slides, thus only in 2D
		\pause
		\item \emph{Solution} (\uct) 3D data
		\pause
		\begin{tikzpicture}[remember picture,overlay]
		    \node[xshift=6cm, yshift=-7cm, rotate=-45] at (current page.north west) {\huge A bit harder\ldots};
		\end{tikzpicture}
	\end{itemize}
\end{frame}
	...
	\begin{columns}
		...
		\begin{column}{0.27\linewidth}
			...
			\begin{tikzpicture}[x=\imagescale,y=-\imagescale]
				...
				\draw[|-|, thick] (\x,\y) -- (\x+83,\y) node [midway,above] {\SI{5}{\milli\meter}};
				\pause
		...
		\begin{column}{0.27\linewidth}%
			...
			\begin{tikzpicture}[x=\imagescale,y=-\imagescale]
				...
				\draw[|-|, thick] (\x,\y) -- (\x+77,\y) node [midway,above] {\SI{5}{\milli\meter}};
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Analysis pipeline in \href{http://github.com/habi/grenoble-brains}{Jupyter notebook with Python}
		\end{itemize}
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{columns}
		...
		\end{column}
		\begin{column}{0.5\linewidth}
			\includegraphics<1>[width=\imsize]{img/imageprocessing/B65_bb_D20T10_rec00003856}
			\includegraphics<2>[width=\imsize]{img/imageprocessing/b65_bb_d20t10_rec0000_voi_1928}
			\includegraphics<3>[width=\imsize]{img/imageprocessing/B65_bb_D20T10_hull_0143}
			\includegraphics<4>[width=\imsize]{img/imageprocessing/B65_bb_D20T10_threshold_0143}
			\includegraphics<5>[width=\imsize]{img/imageprocessing/B65_bb_D20T10_cleaned_0143}
			\includegraphics<6>[width=\imsize]{img/imageprocessing/B65_bb_D20T10_edt_0143}
			\includegraphics<7>[width=\imsize]{img/imageprocessing/B65_bb_D20T10_surface_0143}
			\includegraphics<8>[width=\imsize]{img/imageprocessing/B65_bb_D20T10_label_0143}
		\end{column}
	\end{columns}
\end{frame}
\begin{frame}
	\frametitle{Overview of examples}
	\fullframeimage{img/overviews/b65_bb_d20t10_threshold_}
\end{frame}

\begin{frame}
	\frametitle{3D view: VOI}
	\animategraphics[autoplay,palindrome,width=\imsize]{5}{movies/mov_roi/b65_bb_d20t10_rec0000_voi_0}{001}{025}
\end{frame}

\begin{frame}
	\frametitle{3D view: Thresholded}
	\animategraphics[autoplay,palindrome,width=\imsize]{5}{movies/mov_threshold/b65_bb_d20t10_threshold_0}{001}{025}
\end{frame}

\begin{frame}
	\frametitle{3D view: Cleaned}
	\animategraphics[autoplay,palindrome,width=\imsize]{5}{movies/mov_cleaned/b65_bb_d20t10_cleaned_0}{001}{025}
\end{frame}

\begin{frame}
	\frametitle{3D view: Overlay}
	\animategraphics[autoplay,palindrome,width=\imsize]{5}{movies/mov_overlay/b65_bb_d20t10_threshold_0}{001}{025}
\end{frame}
...
\begin{frame}
	\frametitle{\(\frac{\textrm{Vessel volume}}{\textrm{Tumor volume}}\)}
