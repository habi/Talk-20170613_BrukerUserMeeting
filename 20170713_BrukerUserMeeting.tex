...
\newcommand{\everyframe}{30} % use only every nth frame for the movies
...
\begin{frame}
	...
	\begin{itemize}
		...
		\pause
		\fullframeimage{./img/vreni_rigth-eye_Flyer_6-56um__Contrast-BusinessCard_scalebar.pdf}
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		\item Malignant gliomas (brain tumors) constitute a major therapeutic problem because of extremely poor prognosis; only \SI{5}{\percent} survival rate in \SI{5}{\year}
		\textrightarrow{}
...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{column}{0.309\linewidth}
			...
			\def\x{497}% scalebar-x starting at golden ratio of image width of 805px = 497
			...
			\begin{tikzpicture}[x=\imagescale,y=-\imagescale]
				...
				\draw[|-|,thick] (\x,\y) -- (\x+135,\y) node [right] {\SI{500}{\micro\meter}};
			\end{tikzpicture}%
		\end{column}		
	\end{columns}
